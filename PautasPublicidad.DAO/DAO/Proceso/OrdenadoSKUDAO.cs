...
{
    public class OrdenadoSKUDAO : DAOBase<OrdenadoSKUDTO>
    {
        //Methods...
        public DataTable GetSKUByPiezasArte(List<OrdenadoDetDTO> lineas)
        {
        ...
        public void MoverCeros(string pautaId, SqlTransaction tran)
        {
            DAOHelper.EjecutarNonQuery(
                string.Format(
                "UPDATE [OrdenadoSKU] SET Costo=0, CostoOP=0, CostoUni=0, CostoOPUni=0 WHERE PautaId = '{0}' AND DatareaId = {1}",
