...
<SubMenuStyle GutterImageSpacing="9px" GutterWidth="13px"></SubMenuStyle>
                                                                    ...
                                                                    <ContentCollection>
                                                                        <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                                                            <table width="100%">
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:Literal ID="Literal28" runat="server" Text="Fecha y Hora Desde"></asp:Literal>
                                                                                                            </td>
                                                                                                            <td align="left">
                                                                                                                ...
                                                                                                                <dx:ASPxTimeEdit ID="deHoraDesdeOrigenCopiar" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:Literal ID="Literal29" runat="server" Text="Fecha y Hora Hasta"></asp:Literal>
                                                                                                            </td>
                                                                                                            <td align="left">
                                                                                                                ...
                                                                                                                <dx:ASPxTimeEdit ID="deHoraHastaOrigenCopiar" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                                                                                                    CssPostfix="Office2010Silver" DisplayFormatString="HH:mm" EditFormat="Custom"
                                                                                                                    EditFormatString="HH:mm" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Silver/{0}/sprite.css"
                                                                                                                    Width="20%">
                                                                                                                </dx:ASPxTimeEdit>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:Literal ID="HoraDesde" runat="server" Text="Hora Desde:"></asp:Literal>
                                                                                                            </td>
                                                                                                            <td>
                                                                                                                <dx:ASPxTimeEdit ID="deHoraDesdeDestinoCopiar" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                                                                                                    CssPostfix="Office2010Silver" DisplayFormatString="HH:mm" EditFormat="Custom"
                                                                                                                    EditFormatString="HH:mm" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Silver/{0}/sprite.css"
                                                                                                                    Width="100%">
                                                                                                                </dx:ASPxTimeEdit>
                                                                            ...
                                                                            <td>
                                                                                <dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn     FieldName ="Duracion"  ShowInCustomizationForm="True" VisibleIndex="6" Caption="Duración" ReadOnly="True"></dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataDateColumn     FieldName = "Fecha"    Caption   ="Fecha"             VisibleIndex="7" ReadOnly="True"></dx:GridViewDataDateColumn>
                                                                                        <dx:GridViewCommandColumn ShowInCustomizationForm="False" ShowSelectCheckbox="False" VisibleIndex="8" ButtonType="Image" Width="50px">
                                ...
                                <tr>
                                    ...
                                    <td runat="server" id="tdVersions">
                                       <dx:ASPxButton ID="btnVersions" runat="server" Text="Consultar Vers." Width="150px">
