<%@ Page Title="" Language="C#" MasterPageFile="~/Accendo.Master" AutoEventWireup="true" CodeBehind="EstimadoCierre.aspx.cs" Inherits="PautasPublicidad.Web.Forms.EstimadoCierre" %>
        ...
        <tr>
            <td align="center">
                ...
                <dx:ASPxRoundPanel ID="pnlMain" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                    ...
                    GroupBoxCaptionOffsetY="-19px" HeaderText="Cierre Estimado" 
                ...
                <table runat="server" id="tblCerrar" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <table align="right" >
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxButton ID="Btn_CerrarEstimado" runat="server" OnClick="btnCerrarEstimado"
                                                                    Text="Cerrar Estimado" Width="150px">
                                                                    <Image Url="~/Images/Icons/16_succeeded.png">
                                                                    </Image>
                                                                </dx:ASPxButton>
                                                            </td>
                                                            <td>
                                                                <dx:ASPxButton ID="Btn_CancelarCierreEstimado" runat="server" OnClick="btn_CancelarCierreEstimado" 
                                                                    Text="Cancelar"
                                                                    Width="150px">
