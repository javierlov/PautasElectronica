<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrowseDirectory.aspx.cs" Inherits="PautasPublicidad.Web.Forms.BrowseDirectory" %>
...
<head id="Head1" runat="server">
     <base target="_self"></base>
		<title >Búsqueda de Directorios</title>
    	<style>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0">
                <tr>
                    <td>
                        <span class="text"><b>Búsqueda de directorios:</b></span></td>
                </tr>
                <tr>
                    <td>
                        <span class="text">ejemplo: c:\ </span></td>
                </tr>
               <tr>
