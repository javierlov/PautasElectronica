<%@ Page Title="" Language="C#" MasterPageFile="~/Accendo.Master" AutoEventWireup="true"
    CodeBehind="EstimadoBusqueda.aspx.cs" Inherits="PautasPublicidad.Web.Forms.EstimadoBusqueda" %>
        ...
        <tr>
            <td align="center">
                ...
                <dx:ASPxRoundPanel ID="pnlMain" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                    ...
                    GroupBoxCaptionOffsetY="-19px" HeaderText="Anulación y Reemplazo - Selección de Estimado"
                    SpriteCssFilePath="~/App_Themes/Office2010Silver/{0}/sprite.css" Width="500px">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <dx:ASPxSpinEdit ID="seAño" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                                                                        ...
                                                                                        onnumberchanged="seAño_NumberChanged">
                                                                                ...
                                                                                <td align="left">
                                                                                    <dx:ASPxSpinEdit ID="seMes" runat="server" CssFilePath="~/App_Themes/Office2010Silver/{0}/styles.css"
                                                                                        ...
                                                                                        onnumberchanged="seMes_NumberChanged">
                                                                                        <SpinButtons HorizontalSpacing="0">
                                                                                        </SpinButtons>
                                                                                    </dx:ASPxSpinEdit>
                                                                                </td>
                                                        ...
                                                        <td>
                                                            <table width="100%" style="border: 1px solid grey;">
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                       <asp:TextBox runat="server" Width="170px" ID="txNroPauta" AutoPostBack="True" 
                                                                            ontextchanged="txNroPauta_TextChanged"></asp:TextBox>
