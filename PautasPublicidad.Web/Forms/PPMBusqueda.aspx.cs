    ...
    public partial class BusquedaPautasMensuales2 : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try {
                ...
                Response.Redirect("PlanillaPautasMensuales.aspx?Estado0=" + ucEstado.Text + "&Origen0=" + ucOrigen.Text + "&AnioMes0=" + deAnoMes.Text + "&Mostrado0=0");
        ...
        private void CargarTiposDePautas()
        {
            try 
            {
                ...
                if (certificados.Count > 0) ucEstado.Items.Add("Certificado");

                estimados = Estimados.ReadAll(" ANOMES = '" + AnioMes + "'");
                if (estimados.Count > 0) ucEstado.Items.Add("Estimado");

                ordenados = Ordenados.ReadAll(" ANOMES = '" + AnioMes + "' ");
                if (ordenados.Count > 0) ucEstado.Items.Add("Ordenado");
