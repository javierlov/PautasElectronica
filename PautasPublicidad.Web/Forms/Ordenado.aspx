                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="right" colspan="2">
                                                                                                                                        <table>
                                                                                                                                            <tr>
                                                                                                                                                <td>
                                                                                                                                                    <dx:ASPxButton ID="btnCopiarPeriodos" runat="server" 
                                                                                                                                                        OnClick="btnCopiarPeriodos_Click" Text="Copiar Períodos" Width="150px">
                                                                                                                                                        <Image Url="~/Images/Icons/18_editForm.gif">
                                                                                                                                                        </Image>
                                                                                                                                                    </dx:ASPxButton>
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                                    <dx:ASPxButton ID="btnCancelCopiar" runat="server" OnClick="btnCancel_Click" 
