...
namespace PautasPublicidad.Web.Classes
{
    public class csOP_PRUEBA
    {
        ...
        public csOP_PRUEBA( string Estado               , 
                            string Origen               , 
                            string PautaId              , 
                            OrdenadoCabDTO Cabecera     ,
                            List<OrdenadoDetDTO> Detalle, 
                            List<OrdenadoSKUDTO> SKUS   , 
                            EspacioContDTO Espacio )
        {
            _PautaId  = PautaId  ;
            _Origen   = Origen   ;
            _Estado   = Estado   ;
        ...
        public csOP_PRUEBA(string Estado        ,
                    string Origen               ,
                    string PautaId              ,
                    EstimadoCabDTO Cabecera     ,
                    List<EstimadoDetDTO> Detalle,
                    List<EstimadoSKUDTO> SKUS   ,
                    EspacioContDTO Espacio)
        {
            _PautaId = PautaId   ;
            _Origen = Origen     ;
        ...
        public csOP_PRUEBA(string Estado            ,
                    string Origen                   ,
                    string PautaId                  ,
                    CertificadoCabDTO Cabecera      ,
                    List<CertificadoDetDTO> Detalle ,
                    List<CertificadoSKUDTO> SKUS    ,
                    EspacioContDTO Espacio)
        {
            _PautaId = PautaId   ;
            _Origen = Origen     ;
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            {
                case "ORDENADO":{
                    vTLPSTR2.Text = _Estado + " " + _oCabecera.AnoMes + " " + _oCabecera.IdentifEspacio;                    
                    break;}
                case "ESTIMADO":{
                    vTLPSTR2.Text = _Estado + " " + _eCabecera.AnoMes + " " + _eCabecera.IdentifEspacio; 
                    break;}
                case "CERTIFICADO":{
                    vTLPSTR2.Text = _Estado + " " + _cCabecera.AnoMes + " " + _cCabecera.IdentifEspacio; 
                    break;}
            }
